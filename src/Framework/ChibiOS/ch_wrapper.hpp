...
namespace chibios_rt {
  ...
  public:
    /**
     * @brief   Pointer to the system thread, workspace and size
     */
    ::Thread *thread_ref;
    /**
     ...
     */
    BaseThread(void *workspace, size_t wsize);
  ...
  public:
    ...
    EnhancedThread() : BaseThread(wa, sizeof wa) {}
  };
