 ...
 */
#define SERIAL_TERMINAL         SD3
#define SWITCH_TAMPER_PORT      GPIOC
#define SWITCH_TAMPER_PIN       GPIOC_SWITCH_TAMPER
#define LED_STATUS1_PORT        GPIOC
#define LED_STATUS1_PIN         GPIOC_LED_STATUS1
